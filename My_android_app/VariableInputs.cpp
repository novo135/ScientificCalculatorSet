...
int VariableInputs::execute(string input)
{
	if (!simplestTerms(input))
	{
...
int VariableInputs::preParser(string rawString)
{
	if (rawString.size() >= 64) 
	{
		cout << "Operation too large, you must simplify" << endl;
		return 0;
	}
